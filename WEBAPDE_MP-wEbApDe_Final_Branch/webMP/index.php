...
<div class = "dropup-content">
  <a href="Snake.html">Mini Game 1</a>
  <a href="breaker.html">Mini Game 2</a>
  <a href="Bird.html">Mini game 3</a>>
</div> </div> 
...
<a href="#">
  <div id ="coin_img" class="coin_img"> <?php    
  require ('db.php');
  ...
  if(isset($_POST['post_score']))
  {
    ...
    $game_money=$_POST['post_score'];
    $game_money=$game_money+$previous;
    echo "hello".$game_money;
    $sql = "UPDATE player SET money=$game_money WHERE userID=$user";
